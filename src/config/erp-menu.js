export const erpMenuGroups = [
  ...
  },
  {
    ...
    color: '#ff9f55',
    items: [
      '合同管理', '商品销售', '销售明细', '套餐管理', '卡类套餐', '赠送管理', '优惠管理', '优惠券管理', '赠送项目申请',
      {
        key: 'planned',
        title: '销售合同·规划功能',
        icon: 'time',
  ...
  },
  {
    ...
    color: '#f5ba35',
    items: [
      '新增收款', '收款管理', '退款申请', '退款审核', '欠款审核', '换货审核', '发票管理', '交易对账', '部门物料预算', '我的费用', '费用审核', '付款管理',
      {
        key: 'planned',
        title: '订单财务·规划功能',
        icon: 'time',
  ...
  },
  {
    ...
    color: '#8f7cf6',
    items: [
      '护理中心', '护理计划', '护理部排班第二版', '宝宝档案', '健康评估', '膳食评估', '自定义查房',
      '医生查房记录', '膳食禁忌查房', '护理计划确认', '护理项目记录', '妈妈护理记录',
      '宝宝护理记录', '妈妈护理汇总', '宝宝护理汇总', '护理部排班表', '入住物品交接',
      '护理评估（产后恢复）', '护理看板', '护理二次销售业绩', '入住交接（物品清点）', '宝宝日志'
    ]
  },
  {
    key: 'recovery',
  ...
  },
  {
    ...
    color: '#58b66f',
    items: [
      '客户餐单', '菜品管理', '膳食套餐', '膳食统计', '送餐统计', '营养汤设置', '营养汤统计',
      '客餐供应', '食材采购', '膳食销售', '订餐列表', '餐卡管理', '餐卡消费报表',
      '订餐配送', '月子餐库'
    ]
  },
  {
    ...
    color: '#5886d6',
    items: [
      '采购计划', '采购订单', '采购单审核', '其他入库', '采购入库', '领料申请', '销售出库',
      '领料申请(去金额)', '调拨管理', '退货管理', '盘点管理(NEW)', '报损管理', '期初数据导入',
      '物料库存预警', '期初数据查询', '赠送清单计划', '收发存汇总统计', '库存明细统计',
      '部门领料统计', '仓库库存查询', '采购明细报表', '预付款列表', '付款单列表',
      '应付账款明细表', '库房管理', '跨店调拨', '库存盘点', '库存预警', '采购管理',
      '库存估值', '批次保质期（效期预警）', '供应商管理'
    ]
  },
  {
    key: 'mall',
...
const specialPageTypes = {
  ...
  'F080 厂商并行期对账帮手（开发中）': 'development-placeholder',
  'F082 套餐卡/次卡管理（开发中）': 'development-placeholder',
  'F083 在线支付（开发中）': 'development-placeholder',
  'F089 储值卡/折扣卡/微信卡包（开发中）': 'development-placeholder',
  'F107 电子合同（开发中）': 'development-placeholder'
}
