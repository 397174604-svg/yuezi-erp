<template>
  ...
  <demo-tabbar end="beauty" active="cashier/cashier" />
</template>

<script>
import { loadDashboard, checkout } from '@/common/beauty/remote.js'
import { discountedTotal as discTotal } from '@/common/beauty/logic.js'
export default {
  data() {
  ...
  methods: {
    back() { uni.reLaunch({ url: '/pages/beauty/home/home' }) },
