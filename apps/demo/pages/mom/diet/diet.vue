<template>
  ...
  <demo-tabbar end="mom" active="diet/diet" />
</template>
<script>
...
.order { margin-top: 28rpx; text-align: center; font-size: 27rpx; color: #fff; background: linear-gradient(135deg,#E9D4A4,#9C7838); border-radius: 60rpx; padding: 28rpx; }
