...
<script>
import { askQa } from '@/common/mom/remote.js'
export default {
  data() {
    return {
...
.tag { margin-left: 14rpx; font-size: 20rpx; color: #fff; background: linear-gradient(135deg,#E9D4A4,#9C7838); border-radius: 20rpx; padding: 4rpx 14rpx; }
...
.q text { max-width: 78%; background: linear-gradient(135deg,#E9D4A4,#9C7838); color: #fff; font-size: 27rpx; border-radius: 28rpx 28rpx 6rpx 28rpx; padding: 18rpx 26rpx; line-height: 1.6; }
.a { margin-top: 16rpx; }
...
.send { width: 88rpx; height: 72rpx; border-radius: 36rpx; background: linear-gradient(135deg,#E9D4A4,#9C7838); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 28rpx; }
