<template>
  ...
  <demo-tabbar end="rehab" active="cashier/cashier" />
</template>

<script>
import { loadDashboard, checkout } from '@/common/rehab/remote.js'
import { discountedTotal as discTotal } from '@/common/rehab/logic.js'
export default {
  data() {
  ...
  methods: {
    back() { uni.reLaunch({ url: '/pages/rehab/home/home' }) },
