...
export const EMPTY = { me: {}, journey: {}, onboarding: { isNew: false, needsProfile: false }, balance: { pkg: 0, careCard: 0 }, schedule: [], monthSpent: 0, promo: {}, todayMeals: [], mall: [] };

export const MEMENU = [
  { l: '预约到店参观', page: '/pages/visit/booking' },
  { l: '专家服务建议', page: '/pages/service/recommendations' },
  { l: '到店服务进度', page: '/pages/service/requests' },
  { l: '家庭成员与绑定', page: '/pages/family/invite' },
  { l: '完善个人资料', page: '/pages/profile/edit' },
  { l: '个人中心 / 合同', k: 'profileMom' }, { l: '卡额 / 餐卡', k: 'mealCard' }, { l: '消费账单', k: 'consume' },
  { l: '宝宝成长日记', page: '/pages/baby/timeline' }, // M-A F073：定制时间线页（kind 筛选/照片）
  { l: '护理记录', page: '/pages/care/mine' }, // M-A F074：原通用渲染入口改指向定制「我的产后记录」页
  { l: '产康预约', k: 'apptMom' }, { l: '我的商品订单', k: 'productOrders' },
  { l: '我的积分', k: 'points' }, { l: '月嫂 / 育儿嫂', k: 'nannies' }, { l: '育儿知识', k: 'parenting' },
  { l: 'AI 育儿问答 · 秒回', page: '/pages/qa/qa' },
  { l: '专家问答', k: 'expertQA' }, { l: '辣妈贴吧', k: 'forum' }, { l: '消息中心', k: 'notices' }, { l: '登录与密码', page: '/pages/login/set-password' }
];
